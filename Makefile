...
good1:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)good_code1_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)good_code1.o -ldmallocth
...
bad1:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)bad_code1_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)bad_code1.o -ldmallocth
...
good2:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)good_code2_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)good_code2.o -ldmallocth
...
bad2:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)bad_code2_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)bad_code2.o -ldmallocth
...
good3:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)good_code3_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)good_code3.o -ldmallocth
...
bad3:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)bad_code3_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)bad_code3.o -ldmallocth
...
good4:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)good_code4_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)good_code4.o -ldmallocth
...
bad4:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)bad_code4_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)bad_code4.o -ldmallocth
...
good5:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)good_code5_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)good_code5.o -ldmallocth
...
bad5:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)bad_code5_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)bad_code5.o -ldmallocth
...
good6:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)good_code6_dmalloc.bin $(DIST)mimo_wrappers_dmalloc.o $(CODE)good_code6.c
...
bad6:
	...
	# Removed $(CFLAGS) to avoid compiler warning about the bad code
	$(CC) $(DMALLOC_FLAGS) -o $(DIST)bad_code6_dmalloc.bin $(DIST)mimo_wrappers_dmalloc.o $(CODE)bad_code6.c
...
good7:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)good_code7_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)good_code7.o -ldmallocth
...
bad7:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)bad_code7_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)bad_code7.o -ldmallocth
...
good8:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)good_code8_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)good_code8.o -ldmallocth
...
bad8:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)bad_code8_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)bad_code8.o -ldmallocth
...
good9:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)good_code9_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)good_code9.o -ldmallocth
...
bad9:
	...
	$(CC) $(CFLAGS) $(DMALLOC_FLAGS) -o $(DIST)bad_code9_dmalloc.bin $(DIST)gimme_mem.o $(DIST)mimo_wrappers_dmalloc.o $(DIST)bad_code9.o -ldmallocth
